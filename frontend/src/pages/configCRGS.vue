...
<template>
  <VCard
    :title="$t(titleCard)"
    :subtitle="`CR/GS ${$t('Configuration')}`"
  >
      ...
      <VRow>
        ...
        >
          ...
          >
            ...
            <VCardText>
              <Component
                :is="[1, 3, 4].includes(dataGConf.type_of_contract) ? LayoutCR : LayoutGS"
                :sub-project="0"
              />
            </VCardText>
          </AppCardActions>
        ...
        >
          ...
          >
            ...
            <VCardText>
              <Component
                :is="[3, 6].includes(dataGConf.type_of_contract) ? LayoutCR : LayoutGS"
                :sub-project="1"
              />
            </VCardText>
          </AppCardActions>
