...
import { ExcelColumnType, TableContextMenus, contextMenuType, defContextMenus } from '@/utils/pysc/pyscType';
...
<template>
  <hot-table ref="tblhot" :settings="hotSettings" licenseKey="non-commercial-and-evaluation" />
</template>
