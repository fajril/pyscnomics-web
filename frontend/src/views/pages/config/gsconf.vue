  ...
  <VRow no-gutters>
    <VCol cols="12" class="ms-4 pe-4">
      ...
      <AppTextField label-placeholder="Ministerial Discretion Split, %" class="mt-4"
        v-model.number="ministry_discretion_split"
        :rules="[requiredValidator, numberValidator, betweenValidator(ministry_discretion_split, 0, 100, appStore.showAlert)]" />
      <AppTextField label-placeholder="Base Oil Split, %" class="mt-4"
        :rules="[requiredValidator, numberValidator, betweenValidator(oil_base_split, 0, 100, appStore.showAlert)]"
        v-model.number="oil_base_split" />
      <AppTextField label-placeholder="Base Gas Split, %" class="mt-4"
        :rules="[requiredValidator, numberValidator, betweenValidator(gas_base_split, 0, 100, appStore.showAlert)]"
