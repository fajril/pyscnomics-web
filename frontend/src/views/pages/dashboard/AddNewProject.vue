          ...
          <VForm ref="refForm" v-model="isFormValid" @submit.prevent="onSubmit">
            <VRow>
              <VCol cols="12">
                ...
                <VSelect v-model="dataEditor.type" :items="[...Pysc.Field2Array(Pysc.ContractType)]" item-props
              ...
              <VCol cols="12" class="pt-0">
                <VTextarea v-model="dataEditor.evaluator" clearable clear-icon="tabler-circle-x"
                  label="Name of Evaluator" rows="4" class="mt-4" persistent-placeholder variant="outlined"
                  placeholder="Name of Evaluator" />
              </VCol>
              <VCol cols="12" class="pt-0">
                <AppDateTimePicker :model-value="dataEditor.evaluator_date" label-placeholder="Evaluation Date"
