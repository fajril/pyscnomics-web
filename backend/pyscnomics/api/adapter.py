...
def get_summary_dict(data: dict) -> dict:
    ...
    discounting_mode = convert_str_to_discountingmode(
        str_object=data["summary_arguments"]["discounting_mode"]
    )
...
def get_costrecovery(data: dict, summary_result: bool = True):
    ...
    contract = CostRecovery(
        ...
        oil_ftp_portion=convert_to_float(data["costrecovery"]["oil_ftp_portion"]),
        gas_ftp_is_available=data["costrecovery"]["gas_ftp_is_available"],
        gas_ftp_is_shared=data["costrecovery"]["gas_ftp_is_shared"],
        gas_ftp_portion=convert_to_float(data["costrecovery"]["gas_ftp_portion"]),
        ...
        oil_ctr_pretax_share=convert_to_float(
            data["costrecovery"]["oil_ctr_pretax_share"]
        ),
        gas_ctr_pretax_share=convert_to_float(
            data["costrecovery"]["gas_ctr_pretax_share"]
        ),
        oil_ic_rate=convert_to_float(data["costrecovery"]["oil_ic_rate"]),
        gas_ic_rate=convert_to_float(data["costrecovery"]["gas_ic_rate"]),
        ic_is_available=data["costrecovery"]["ic_is_available"],
        oil_cr_cap_rate=convert_to_float(data["costrecovery"]["oil_cr_cap_rate"]),
        gas_cr_cap_rate=convert_to_float(data["costrecovery"]["gas_cr_cap_rate"]),
        oil_dmo_volume_portion=convert_to_float(
            data["costrecovery"]["oil_dmo_volume_portion"]
        ),
        oil_dmo_fee_portion=convert_to_float(
            data["costrecovery"]["oil_dmo_fee_portion"]
        ),
        oil_dmo_holiday_duration=data["costrecovery"]["oil_dmo_holiday_duration"],
        gas_dmo_volume_portion=convert_to_float(
            data["costrecovery"]["gas_dmo_volume_portion"]
        ),
        gas_dmo_fee_portion=convert_to_float(
            data["costrecovery"]["gas_dmo_fee_portion"]
        ),
    ...
    contract_arguments_dict = {
        ...
        "tax_rate": convert_list_to_array_float_or_array_or_none(
            data_list=data["contract_arguments"]["tax_rate"]
        ),
        ...
        "lbt_rate": convert_list_to_array_float_or_array(
            data_input=data["contract_arguments"]["lbt_rate"]
        ),
        "inflation_rate": convert_list_to_array_float_or_array(
            data_input=data["contract_arguments"]["inflation_rate"]
        ),
        "future_rate": convert_to_float(data["contract_arguments"]["future_rate"]),
...
def get_grosssplit(data: dict, summary_result: bool = True):
    ...
    contract = GrossSplit(
        ...
        base_split_ctr_oil=convert_to_float(data["grosssplit"]["base_split_ctr_oil"]),
        base_split_ctr_gas=convert_to_float(data["grosssplit"]["base_split_ctr_gas"]),
        split_ministry_disc=convert_to_float(data["grosssplit"]["split_ministry_disc"]),
        oil_dmo_volume_portion=convert_to_float(
            data["grosssplit"]["oil_dmo_volume_portion"]
        ),
        oil_dmo_fee_portion=convert_to_float(data["grosssplit"]["oil_dmo_fee_portion"]),
        oil_dmo_holiday_duration=data["grosssplit"]["oil_dmo_holiday_duration"],
        gas_dmo_volume_portion=convert_to_float(
            data["grosssplit"]["gas_dmo_volume_portion"]
        ),
        gas_dmo_fee_portion=convert_to_float(data["grosssplit"]["gas_dmo_fee_portion"]),
