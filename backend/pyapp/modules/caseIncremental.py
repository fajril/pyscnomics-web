...
class INCRCase:
    ...
    def apply(
        ...
        if incr is not None:
            year_ = np.array(list(incr["C_Year"]))
            lenY_ = len(year_)
            ...
            return INCRCase(
                ...
                0,
                C_Year=year_,
                C_Lifting_Oil=np.array(list(incr["C_Lifting_Oil"])),
                C_Lifting_Gas=np.array(list(incr["C_Lifting_Gas"])),
                C_Oil_Revenue=np.array(list(incr["C_Oil_Revenue"])),
                C_Gas_Revenue=np.array(list(incr["C_Gas_Revenue"])),
                C_Revenue=np.array(list(incr["C_Revenue"])),
                C_Oil_tangible=np.array(list(incr["C_Oil_tangible"])),
                C_Gas_tangible=np.array(list(incr["C_Gas_tangible"])),
                C_Depreciable=np.array(list(incr["C_Depreciable"])),
                C_Intangible=np.array(list(incr["C_Intangible"])),
                C_Opex=np.array(list(incr["C_Opex"])),
                C_ASR=np.array(list(incr["C_ASR"])),
                C_Depreciation=np.array(list(incr["C_Depreciation"])),
                C_Non_Capital=np.array(list(incr["C_Non_Capital"])),
                C_Oil_Sunk_Cost=np.array(list(incr["C_Oil_Sunk_Cost"])),
                C_Gas_Sunk_Cost=np.array(list(incr["C_Gas_Sunk_Cost"])),
                C_Sunk_Cost=np.array(list(incr["C_Sunk_Cost"])),
                C_Total_Expenses=np.array(list(incr["C_Total_Expenses"])),
                # CostRecovery Section
                C_FTP=(
                    np.array(list(incr["C_FTP"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_FTP_CTR=(
                    np.array(list(incr["C_FTP_CTR"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_FTP_GOV=(
                    np.array(list(incr["C_FTP_GOV"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_IC=(
                    np.array(list(incr["C_IC"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Unrecovered_before_TF=(
                    np.array(list(incr["C_Unrecovered_before_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Cost_Recovery=(
                    np.array(list(incr["C_Cost_Recovery"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_ETS_before_TF=(
                    np.array(list(incr["C_ETS_before_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Unrecovered_after_TF=(
                    np.array(list(incr["C_Unrecovered_after_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Cost_to_be_Recovered_after_TF=(
                    np.array(list(incr["C_Cost_to_be_Recovered_after_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Cost_Recovery_after_TF=(
                    np.array(list(incr["C_Cost_Recovery_after_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_ETS_after_TF=(
                    np.array(list(incr["C_ETS_after_TF"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                # ------------------
                # GrossSplit Section
                C_Cost_To_Be_Deducted=(
                    np.array(list(incr["C_Cost_To_Be_Deducted"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Carry_Forward_Cost=(
                    np.array(list(incr["C_Carry_Forward_Cost"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Deductible_Cost=(
                    np.array(list(incr["C_Deductible_Cost"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Carry_Forward_Cost_after_TF=(
                    np.array(list(incr["C_Carry_Forward_Cost_after_TF"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                C_CTR_Share_After=(
                    np.array(list(incr["C_CTR_Share_After"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                C_CTR_Net_Operating_Profit=(
                    np.array(list(incr["C_CTR_Net_Operating_Profit"]))
                    if hasGS
                    else np.zeros(lenY_, dtype=float)
                ),
                # ------------------
                C_Contractor_Share=np.array(list(incr["C_Contractor_Share"])),
                C_Government_Share=np.array(list(incr["C_Government_Share"])),
                C_DMO_Volume=np.array(list(incr["C_DMO_Volume"])),
                C_DMO_Fee=np.array(list(incr["C_DMO_Fee"])),
                C_DDMO=np.array(list(incr["C_DDMO"])),
                C_Taxable_Income=np.array(list(incr["C_Taxable_Income"])),
                # CostRecovery Section
                C_Tax_Due=(
                    np.array(list(incr["C_Tax_Due"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                C_Unpaid_Tax_Balance=(
                    np.array(list(incr["C_Unpaid_Tax_Balance"]))
                    if hasCR
                    else np.zeros(lenY_, dtype=float)
                ),
                # ------------------
                C_Tax_Payment=np.array(list(incr["C_Tax_Payment"])),
                C_CTR_Net_Share=np.array(list(incr["C_CTR_Net_Share"])),
                C_Contractor_Take=np.array(list(incr["C_Contractor_Take"])),
                C_Cashflow=np.array(list(incr["C_Cashflow"])),
                C_Cum_Cashflow=np.array(list(incr["C_Cum_Cashflow"])),
                C_Government_Take=np.array(list(incr["C_Government_Take"])),
            )
        elif years is not None:
            return INCRCase(years[0], years[1])
        return INCRCase()
    ...
    def __isub__(self, other):
        if isinstance(other, INCRCase):
            ...
            raise Exception("Must reduce an instance of INCRCase with another")
...
class CaseIncremental:
    ...
    def __init__(
        ...
        contract = [
            (
                get_costrecovery(data=dataJson[i], summary_result=False)[1]
                if ctrType[i] == 1
                else (
        ...
        for i, _contract in enumerate(contract):
            if i == 0:
                if isinstance(_contract, CostRecovery):
                    self._rdxCase = self.updateDist(
                        INCRCase().make_CostRecovery(_contract)
                    )
                elif isinstance(_contract, GrossSplit):
                    self._rdxCase = self.updateDist(
                        INCRCase().make_GrossSplit(_contract)
                    )
            else:
                if isinstance(_contract, CostRecovery):
                    self._rdxCase -= self.updateDist(
    ...
    def updateDist(self, values: INCRCase):
    ...
    def redux(self):
        hasCR = np.in1d(1, self.ctrType)[0]
        hasGS = np.in1d(2, self.ctrType)[0]
        _summ = {
            "C_Year": self._rdxCase.C_Year.tolist(),
            "C_Lifting_Oil": self._rdxCase.C_Lifting_Oil.tolist(),
            "C_Lifting_Gas": self._rdxCase.C_Lifting_Gas.tolist(),
            "C_Oil_Revenue": self._rdxCase.C_Oil_Revenue.tolist(),
            "C_Gas_Revenue": self._rdxCase.C_Gas_Revenue.tolist(),
            "C_Revenue": self._rdxCase.C_Revenue.tolist(),
            "C_Oil_tangible": self._rdxCase.C_Oil_tangible.tolist(),
            "C_Gas_tangible": self._rdxCase.C_Gas_tangible.tolist(),
            "C_Depreciable": self._rdxCase.C_Depreciable.tolist(),
            "C_Intangible": self._rdxCase.C_Intangible.tolist(),
            "C_Opex": self._rdxCase.C_Opex.tolist(),
            "C_ASR": self._rdxCase.C_ASR.tolist(),
            "C_Depreciation": self._rdxCase.C_Depreciation.tolist(),
            "C_Non_Capital": self._rdxCase.C_Non_Capital.tolist(),
            "C_Oil_Sunk_Cost": self._rdxCase.C_Oil_Sunk_Cost.tolist(),
            "C_Gas_Sunk_Cost": self._rdxCase.C_Gas_Sunk_Cost.tolist(),
            "C_Sunk_Cost": self._rdxCase.C_Sunk_Cost.tolist(),
            "C_Total_Expenses": self._rdxCase.C_Total_Expenses.tolist(),
        }
        if hasCR:
            _summ.update(
                {
                    "C_FTP": self._rdxCase.C_FTP.tolist(),
                    "C_FTP_CTR": self._rdxCase.C_FTP_CTR.tolist(),
                    "C_FTP_GOV": self._rdxCase.C_FTP_GOV.tolist(),
                    "C_IC": self._rdxCase.C_IC.tolist(),
                    "C_Unrecovered_before_TF": self._rdxCase.C_Unrecovered_before_TF.tolist(),
                    "C_Cost_Recovery": self._rdxCase.C_Cost_Recovery.tolist(),
                    "C_ETS_before_TF": self._rdxCase.C_ETS_before_TF.tolist(),
                    "C_Unrecovered_after_TF": self._rdxCase.C_Unrecovered_after_TF.tolist(),
                    "C_Cost_to_be_Recovered_after_TF": self._rdxCase.C_Cost_to_be_Recovered_after_TF.tolist(),
                    "C_Cost_Recovery_after_TF": self._rdxCase.C_Cost_Recovery_after_TF.tolist(),
                    "C_ETS_after_TF": self._rdxCase.C_ETS_after_TF.tolist(),
                }
            )
        if hasGS:
            _summ.update(
                {
                    "C_Cost_To_Be_Deducted": self._rdxCase.C_Cost_To_Be_Deducted.tolist(),
                    "C_Carry_Forward_Cost": self._rdxCase.C_Carry_Forward_Cost.tolist(),
                    "C_Deductible_Cost": self._rdxCase.C_Deductible_Cost.tolist(),
                    "C_Carry_Forward_Cost_after_TF": self._rdxCase.C_Carry_Forward_Cost_after_TF.tolist(),
                    "C_CTR_Share_After": self._rdxCase.C_CTR_Share_After.tolist(),
                    "C_CTR_Net_Operating_Profit": self._rdxCase.C_CTR_Net_Operating_Profit.tolist(),
                }
            )
        _summ.update(
            {
                "C_Contractor_Share": self._rdxCase.C_Contractor_Share.tolist(),
                "C_Government_Share": self._rdxCase.C_Government_Share.tolist(),
                "C_DMO_Volume": self._rdxCase.C_DMO_Volume.tolist(),
                "C_DMO_Fee": self._rdxCase.C_DMO_Fee.tolist(),
                "C_DDMO": self._rdxCase.C_DDMO.tolist(),
                "C_Taxable_Income": self._rdxCase.C_Taxable_Income.tolist(),
            }
        )
        if hasCR:
            _summ.update(
                {
                    "C_Tax_Due": self._rdxCase.C_Tax_Due.tolist(),
                    "C_Unpaid_Tax_Balance": self._rdxCase.C_Unpaid_Tax_Balance.tolist(),
                }
            )
        _summ.update(
            {
                "C_Tax_Payment": self._rdxCase.C_Tax_Payment.tolist(),
                "C_CTR_Net_Share": self._rdxCase.C_CTR_Net_Share.tolist(),
                "C_Contractor_Take": self._rdxCase.C_Contractor_Take.tolist(),
                "C_Cashflow": self._rdxCase.C_Cashflow.tolist(),
                "C_Cum_Cashflow": self._rdxCase.C_Cum_Cashflow.tolist(),
                "C_Government_Take": self._rdxCase.C_Government_Take.tolist(),
            }
        )
        ...
        # Lifting
        lifting_oil = np.sum(self._rdxCase.C_Lifting_Oil)
        if lifting_oil == 0:
            oil_wap = 0.0
        else:
            oil_wap = np.divide(
                np.sum(self._rdxCase.C_Oil_Revenue),
                lifting_oil,
                where=lifting_oil != 0,
            )
        lifting_gas = np.sum(self._rdxCase.C_Lifting_Gas)
        if lifting_gas == 0:
            gas_wap = 0.0
        else:
            gas_wap = np.divide(
                np.sum(self._rdxCase.C_Gas_Revenue),
                lifting_gas,
                where=lifting_gas != 0,
            )

        # Gross Revenue
        gross_revenue_oil = np.sum(self._rdxCase.C_Oil_Revenue)
        gross_revenue_gas = np.sum(self._rdxCase.C_Gas_Revenue)
        gross_revenue = np.sum(gross_revenue_oil + gross_revenue_gas)

        # Sunk Cost
        sunk_cost = np.sum(self._rdxCase.C_Sunk_Cost)

        # Investment (Capital Cost)
        sunk_cost_extended = np.concatenate(
            (
                self._rdxCase.C_Sunk_Cost,
                np.zeros(len(self._rdxCase.C_Year) - len(self._rdxCase.C_Sunk_Cost)),
            )
        )

        tangible = np.sum(self._rdxCase.C_Depreciable)

        intangible = np.sum(self._rdxCase.C_Intangible - sunk_cost_extended)

        investment = tangible + intangible

        # Capex
        oil_capex = np.sum(self._rdxCase.C_Oil_tangible)
        gas_capex = np.sum(self._rdxCase.C_Gas_tangible)

        # OPEX and ASR (Non-Capital Cost)
        opex = np.sum(self._rdxCase.C_Opex)
        asr = np.sum(self._rdxCase.C_ASR)

        # Cashflow sunk cost
        if sunk_cost == 0:
            cashflow_sunk_cost_pooled = self._rdxCase.C_Cashflow
        else:
            cashflow_sunk_cost_pooled = np.concatenate(
                (
                    np.array([-sunk_cost]),
                    self._rdxCase.C_Cashflow[len(self._rdxCase.C_Sunk_Cost) :],
                )
            )

        # Years sunk cost pooled
        years_sunk_cost_pooled = self._rdxCase.C_Year[
            (len(self._rdxCase.C_Year) - len(cashflow_sunk_cost_pooled)) :
        ]

        # Government DDMO
        gov_ddmo = np.sum(self._rdxCase.C_DDMO)

        # Government Take Income
        gov_tax_income = np.sum(self._rdxCase.C_Tax_Payment)

        # Government Take
        gov_take = np.sum(self._rdxCase.C_Government_Take)
        ...
        # Contractor IRR
        ctr_irr = irr(cashflow=self._rdxCase.C_Cashflow)
        ...
        if self.npv_mode == NPVSelection.NPV_SKK_REAL_TERMS:
            ...
            ctr_npv = npv_skk_real_terms(
                cashflow=self._rdxCase.C_Cashflow,
                cashflow_years=self._rdxCase.C_Year,
            ...
            investment_npv = npv_skk_real_terms(
                cashflow=(
                    self._rdxCase.C_Depreciable
                    + self._rdxCase.C_Intangible
                    - sunk_cost_extended
                ),
                cashflow_years=self._rdxCase.C_Year,
                discount_rate=self.discount_rate,
            ...
            gov_take_npv = npv_skk_real_terms(
                cashflow=self._rdxCase.C_Government_Take,
                cashflow_years=self._rdxCase.C_Year,
                discount_rate=self.discount_rate,
                reference_year=self.reference_year,
                discounting_mode=self.discounting_mode,
        ...
        # NPV Calculation for Point Forwards
            ...
            ref_year_arr = np.full_like(
                self._rdxCase.C_Cashflow, fill_value=self.reference_year
            )
            cashflow_point_forward = np.where(
                self._rdxCase.C_Year >= ref_year_arr,
                self._rdxCase.C_Cashflow,
                0,
            )
            gross_revenue_point_forward = np.where(
                self._rdxCase.C_Year >= ref_year_arr,
                self._rdxCase.C_Revenue,
                0,
            )
        ...
        # CTR Gross Share
        ctr_gross_share = np.sum(self._rdxCase.C_Contractor_Share)

        # GOV GOV Gross Share
        gov_gross_share = np.sum(self._rdxCase.C_Government_Share)

        # Cost Recovery
        cost_recovery = np.sum(self._rdxCase.C_Cost_Recovery_after_TF)
        cost_recovery_over_gross_rev = np.divide(
            cost_recovery, gross_revenue, where=gross_revenue != 0
        )

        # Unrecoverable Cost
        unrec_cost = self._rdxCase.C_Unrecovered_after_TF[-1]
        ...
        #  Deductible Cost
        deductible_cost = np.sum(self._rdxCase.C_Deductible_Cost)
        deductible_cost_over_gross_rev = np.divide(
            deductible_cost, gross_revenue, where=gross_revenue != 0
        )

        # Carry Forward Cost
        carry_forward_deductible_cost = self._rdxCase.C_Carry_Forward_Cost[-1]
        ...
        ctr_net_share = np.sum(self._rdxCase.C_CTR_Net_Share, dtype=float)
        ctr_net_share_over_gross_share = np.divide(
            ctr_net_share, gross_revenue, where=gross_revenue != 0
        )

        # Contractor Net Cashflow
        ctr_net_cashflow = np.sum(self._rdxCase.C_Cashflow, dtype=float)
        ctr_net_cashflow_over_gross_rev = np.divide(
            ctr_net_cashflow, gross_revenue, where=gross_revenue != 0
        )

        # Government FTP Share
        gov_ftp_share = np.sum(self._rdxCase.C_FTP_GOV)

        # Government Equity Share
        gov_equity_share = np.sum(self._rdxCase.C_Government_Share)
        ...
        _dataCard = {
            ...
            "ctr": {
                ...
                "PI": ctr_pi,
                "NPV": ctr_npv,
                "CF": np.sum(self._rdxCase.C_Cashflow),
            },
            "gov": {
                "GovTake": gov_take,
