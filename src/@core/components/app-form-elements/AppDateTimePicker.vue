...
<template>
  <div class="app-picker-field">
    <!-- v-input -->
    <VLabel
      v-if="props.labelPlaceholder === undefined && fieldProps.label"
    ...
    >
      <template #default="{ id, isDirty, isValid, isDisabled, isReadonly }">
        ...
        <VField
          ...
          :id="id.value"
          role="textbox"
          :label="labelPlaceholder ? (Array.isArray(labelPlaceholder) ? (`${labelPlaceholder[0]}${labelPlaceholder.slice(1)}`) : labelPlaceholder) : undefined"
